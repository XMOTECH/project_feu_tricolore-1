...
class SimulationController:
    def __init__(self):
        ...
        self.light_N = TrafficLight(-80, 150)  # Coin Haut-Gauche
        self.light_S = TrafficLight(80, -150)  # Coin Bas-Droite
        
        # Est et Ouest (Axe Horizontal)
        self.light_E = TrafficLight(150, 80)   # Coin Droite-Haut
        self.light_W = TrafficLight(-150, -80) # Coin Gauche-Bas
