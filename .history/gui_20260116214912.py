...
class InterfaceManager:
    def __init__(self):
        ...
        # ... suite des boutons existants ...
        
        # Sélecteurs de Scénarios (Petits boutons en bas)
        self.buttons.append(Button("1. Normal", -350, -250, 80, 20, "gray", "SCENARIO_1"))
        self.buttons.append(Button("2. Pointe", -260, -250, 80, 20, "gray", "SCENARIO_2"))
        self.buttons.append(Button("3. Nuit", -170, -250, 80, 20, "gray", "SCENARIO_3"))
        self.buttons.append(Button("4. Manuel", -80, -250, 80, 20, "gray", "SCENARIO_4"))
        
        # Bouton Action Manuelle (visible uniquement si nécessaire)
        self.buttons.append(Button("CHANGER FEU", 50, -250, 100, 20, "purple", "MANUAL_CLICK"))
